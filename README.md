...
All that should be necessary to run zinal is to have [Racket](https://racket-lang.org/download/) installed on your machine. **Make sure you download Racket from their website**
